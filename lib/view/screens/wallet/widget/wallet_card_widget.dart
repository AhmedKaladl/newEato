      ...
      builder: (userController) {
        return Column(
          ...
          children: [
            Stack(children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: fromWallet ? Get.find<ThemeController>().darkTheme ? Colors.white60 : const Color(0xff3A3E42) : Theme.of(context).disabledColor.withOpacity(0.2),
                ),
                child:  Row(mainAxisAlignment: fromWallet ? MainAxisAlignment.start : MainAxisAlignment.center, children: [
                  ...
                  fromWallet ? Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                    Text('wallet_amount'.tr,style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor)),
                    const SizedBox(height: Dimensions.paddingSizeSmall),

                    Row(children: [
                      Text(
                        PriceConverter.convertPrice(userController.userInfoModel!.walletBalance), textDirection: TextDirection.ltr,
                        style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Theme.of(context).cardColor),
                      ),
                      ...
                      Get.find<SplashController>().configModel!.addFundStatus! ? JustTheTooltip(
                        ...
                        content: Padding(
                          ...
                          child: Text(
                            ...
                            style: IBMPlexSansArabicRegular.copyWith(color: Colors.white),
                          ),
                        ),
                        child: InkWell(
                    ...
                    Text(
                      ...
                      style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Theme.of(context).textTheme.bodyLarge!.color),
                    ),
            ...
            ResponsiveHelper.isDesktop(context) ? Text('how_to_use'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge)) : const SizedBox(),
            ResponsiveHelper.isDesktop(context) ? const SizedBox(height: Dimensions.paddingSizeDefault) : const SizedBox(),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text('convert_your_loyalty_point_to_wallet_money'.tr, style: IBMPlexSansArabicRegular),
                    Text('${'minimun'.tr} ${Get.find<SplashController>().configModel!.loyaltyPointExchangeRate} ${'points_required_to_convert_into_currency'.tr}', style: IBMPlexSansArabicRegular),
                  ],
                ),
              ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('earn_money_to_your_wallet_by_completing_the_offer_challenged'.tr, style: IBMPlexSansArabicRegular),
                Text('convert_your_loyalty_points_into_wallet_money'.tr, style: IBMPlexSansArabicRegular),
                Text('amin_also_reward_their_top_customers_with_wallet_money'.tr, style: IBMPlexSansArabicRegular),
                Text('send_your_wallet_money_while_order'.tr, style: IBMPlexSansArabicRegular),
              ],
            ),
          ),
