...
class FundPaymentDialog extends StatelessWidget {
  ...
  const FundPaymentDialog({Key? key, required this.isSubscription}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            TextButton(
              ...
              child: Text(isSubscription ? 'cancel_payment'.tr : 'cancel_add_fund'.tr, textAlign: TextAlign.center, style: IBMPlexSansArabicBold.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color)),
            ),
          ]),
        ),
      ),
