          ...
          builder: (walletController) {
            return Container(
              ...
              height: walletController.amountEmpty && inputAmountController.text.isNotEmpty && Get.find<SplashController>().configModel!.activePaymentMethodList!.isNotEmpty
                  ? context.height * 0.5 : context.height * 0.34,
              ...
              child: Column(
                children: [
                  ...
                  Text('add_fund_to_wallet'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                  const SizedBox(height: Dimensions.paddingSizeSmall),

                  Text('add_fund_form_secured_digital_payment_gateways'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center),
                  const SizedBox(height: Dimensions.paddingSizeLarge),
                  ...
                  walletController.amountEmpty ? Row(children: [
                    Text('payment_method'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                    Expanded(child: Text('faster_and_secure_way_to_pay_bill'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor))),
                  ]) : const SizedBox(),
