...
import 'package:efood_multivendor/view/screens/wallet/widget/wallet_card_widget.dart';
import 'package:efood_multivendor/view/screens/wallet/widget/wallet_history_widget.dart';
import 'package:efood_multivendor/view/screens/wallet/widget/web_bonus_banner.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: isLoggedIn && !ResponsiveHelper.isDesktop(context) && !widget.fromWallet ? FloatingActionButton.extended(
        ...
        label: Text( 'convert_to_wallet_money'.tr, style: IBMPlexSansArabicBold.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeDefault)),
        onPressed: (){
          Get.dialog(
