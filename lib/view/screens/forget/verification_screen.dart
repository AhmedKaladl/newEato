          ...
          child: GetBuilder<AuthController>(builder: (authController) {
            return Column(children: [
              ...
              Get.find<SplashController>().configModel!.demo! ? Text(
                'for_demo_purpose'.tr, style: IBMPlexSansArabicRegular,
              ) : SizedBox(
                width: 210,
                child: Wrap(crossAxisAlignment: WrapCrossAlignment.center, children: [
                    RichText(text: TextSpan(children: [
                      TextSpan(text: 'enter_the_verification_sent_to'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).disabledColor)),
                      TextSpan(text: ' $_number', style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color)),
                    ])),
                  ],
                ),
              ),
                          ...
                          showAnimatedDialog(context, Center(
                            child: Container(
                              ...
                              child: Column(mainAxisSize: MainAxisSize.min, children: [
                                ...
                                Text('verified'.tr, style: IBMPlexSansArabicBold.copyWith(
