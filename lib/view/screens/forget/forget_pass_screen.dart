...
class _ForgetPassScreenState extends State<ForgetPassScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Scrollbar(child: SingleChildScrollView(
                ...
                Padding(
                  ...
                  child: Column(children: [
                    ...
                    Padding(
                      ...
                      child: Text('please_enter_mobile'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: widget.fromDialog ? Dimensions.fontSizeSmall : null), textAlign: TextAlign.center),
                    ),
                    ...
                    RichText(text: TextSpan(children: [
                      ...
                      TextSpan(
                        text: 'help_and_support'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeDefault),
