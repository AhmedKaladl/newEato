        ...
        child: SizedBox(
          ...
          child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Padding(
                padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                child: Text(description, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor), textAlign: TextAlign.center),
              ),
                ...
                return !locationController.isLoading ? Row(children: [
                  Expanded(child: TextButton(
                    ...
                    child: Text(
                      ...
                      style: IBMPlexSansArabicBold.copyWith(color: Theme.of(context).cardColor),
                    ),
                  )),
