        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
          ...
          Padding(
            ...
            child: Row(children: [
              ...
              Text('how_it_works'.tr , style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeDefault), textAlign: TextAlign.center),
            ]),
          ),
              ...
              itemBuilder: (context, index){
                return Padding(
                  ...
                  child: Row(children: [
                    ...
                    Text(AppConstants.dataList[index].tr, style: IBMPlexSansArabicRegular),
