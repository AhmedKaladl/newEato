                                            ...
                                            children: [
                                              ...
                                              Center(
                                                child: TextButton.icon(
                                                  ...
                                                  label: Text('add_more_items'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeDefault)),
                                                ),
                                              ),
          ...
          return restaurantController.suggestedItems != null && suggestedItems!.isNotEmpty ? Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text('you_may_also_like'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
              ),
          ...
          return Column(children: [
            Align(
              ...
              child: Padding(
                ...
                child: Text('order_summary'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
              ),
            ),
            ...
            Padding(
              ...
              child: Column(children: [
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  PriceConverter.convertAnimationPrice(cartController.itemPrice, textStyle: IBMPlexSansArabicRegular),
                  // Text(PriceConverter.convertPrice(cartController.itemPrice), style: IBMPlexSansArabicRegular, textDirection: TextDirection.ltr),
                ]),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  restaurantController.restaurant != null ? Row(children: [
                    ...
                    PriceConverter.convertAnimationPrice(cartController.itemDiscountPrice, textStyle: IBMPlexSansArabicRegular),
                  ]) : Text('calculating'.tr, style: IBMPlexSansArabicRegular),
                  // Text('(-) ${PriceConverter.convertPrice(cartController.itemDiscountPrice)}', style: IBMPlexSansArabicRegular, textDirection: TextDirection.ltr),
                ]),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Row(children: [
                      Text('(+)', style: IBMPlexSansArabicRegular),
                      PriceConverter.convertAnimationPrice(cartController.addOns, textStyle: IBMPlexSansArabicRegular),
                    ]),
                    // Text('(+) ${PriceConverter.convertPrice(cartController.addOns)}', style: IBMPlexSansArabicRegular, textDirection: TextDirection.ltr),
                  ],
                ),
                ...
                isDesktop ? Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('subtotal'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor)),
                      PriceConverter.convertAnimationPrice(cartController.subTotal, textStyle: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).primaryColor)),
                    ],
                  ),
                ) : const SizedBox(),
  ...
  Widget cutleryView(RestaurantController restaurantController, CartController cartController) {
    ...
    return (restaurantController.restaurant != null && restaurantController.restaurant!.cutlery!) ? Container(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('add_cutlery'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor)),
            const SizedBox(height: Dimensions.paddingSizeExtraSmall),

            Text('do_not_have_cutlery'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
          ]),
        ),
      ...
      child: Column(
        ...
        children: [
          InkWell(
            ...
            child: Row(children: [
              Expanded(child: Text('if_any_product_is_not_available'.tr, style: IBMPlexSansArabicMedium, maxLines: 2, overflow: TextOverflow.ellipsis)),
          ...
          cartController.notAvailableIndex != -1 ? Row(children: [
            Text(cartController.notAvailableList[cartController.notAvailableIndex].tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)),
                    ...
                    child: Column(children: [
                        Row(children: [
                          ...
                          PriceConverter.convertAnimationPrice(
                            ...
                            textStyle: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor),
                          ),

                          // Text(PriceConverter.convertPrice(Get.find<SplashController>().configModel!.freeDeliveryOver! - cartController.subTotal), style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor)),
                          const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                          Text('more_for_free_delivery'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).disabledColor)),
                        ]),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                  ...
                  !isDesktop ? Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        //   style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor), textDirection: TextDirection.ltr,
                        // ),
                      ],
                    ),
                  ) : const SizedBox(),
