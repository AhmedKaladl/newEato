      ...
      child: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('if_any_product_is_not_available'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
            IconButton(
              onPressed: ()=> Get.back(),
                ...
                return InkWell(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: cartController.notAvailableIndex == index ? Theme.of(context).cardColor : Theme.of(context).disabledColor),
                    ),
                  ),
                );
              });
