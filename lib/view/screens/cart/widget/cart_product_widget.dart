              ...
              children: [
                ...
                Row(children: [
                    ...
                    children: [
                      ...
                      isAvailable ? const SizedBox() : Positioned(
                        ...
                        child: Container(
                          ...
                          child: Text('not_available_now_break'.tr, textAlign: TextAlign.center, style: IBMPlexSansArabicRegular.copyWith(
                      ...
                      Row(
                        children: [
                          ...
                          cart.discountedPrice!+cart.discountAmount! > cart.discountedPrice! ? Text(
                            ...
                            style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall, decoration: TextDecoration.lineThrough),
                          ) : const SizedBox(),
                        ],
                      ),
                    ]),
                  ...
                  Row(children: [
                    ...
                    // Text(cart.quantity.toString(), style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                    QuantityButton(
                ...
                variationText.isNotEmpty ? Padding(
                  ...
                  child: Row(children: [
                    const SizedBox(width: 80),
                    Text('${'variations'.tr}: ', style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                    Flexible(child: Text(
                      variationText,
                      style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                    )),
...
//                             style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Colors.white),
//                           ),
//                         ) : const SizedBox(),
...
//                         const SizedBox(width: 80),
//                         Text('${'variations'.tr}: ', style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall), textDirection: TextDirection.ltr),
//                         Flexible(child: Text(variationText, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
//                         ),
//                       ]),
//                     ) : const SizedBox(),
//
