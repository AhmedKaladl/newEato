          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Text(title, style: IBMPlexSansArabicMedium.copyWith(color: select ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyMedium!.color)),
...
//
//                 Text(title, style: IBMPlexSansArabicRegular.copyWith(color: select ? Theme.of(context).primaryColor : Theme.of(context).disabledColor)),
//                 const SizedBox(width: 5),
//
//                 // Text(
//                 //   '(${(value == 'take_away' || isFree) ? 'free'.tr : charge != -1 ? PriceConverter.convertPrice(charge) : 'calculating'.tr})',
