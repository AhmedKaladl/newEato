                    ...
                    child: Row(children: [
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Row(children: [
                          Flexible(
                            child: Text(
                              ...
                              style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeDefault - (scrollingRate * (isDesktop ? 2 : Dimensions.fontSizeDefault)), overflow: TextOverflow.ellipsis, color: Theme.of(context).textTheme.bodyLarge!.color),
                            ),
                          ),
                        ...
                        Text(
                          ...
                          style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall - (scrollingRate * (isDesktop ? 2 : Dimensions.fontSizeSmall))),
                        ...
                        Row(children: [
                          Text(
                            '${'min_purchase'.tr} ',
                            style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall - (scrollingRate * (isDesktop ? 2 : Dimensions.fontSizeSmall))),
