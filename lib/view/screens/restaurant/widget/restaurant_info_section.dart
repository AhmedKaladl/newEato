...
import 'package:efood_multivendor/view/screens/restaurant/widget/coupon_view.dart';
...
class RestaurantInfoSection extends StatelessWidget {
  ...
  const RestaurantInfoSection({Key? key, required this.restaurant, required this.restController}) : super(key: key);
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            InfoView(restaurant: restaurant, restController: restController, scrollingRate: scrollingRate),
                            SizedBox(height: Dimensions.paddingSizeLarge - (scrollingRate * (isDesktop ? 2 : Dimensions.paddingSizeLarge))),

                            scrollingRate < 0.8 ? CouponView(scrollingRate: scrollingRate) : const SizedBox(),
