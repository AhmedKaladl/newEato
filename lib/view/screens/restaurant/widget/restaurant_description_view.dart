    ...
    return Column(children: [
      ResponsiveHelper.isDesktop(context) ? Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(
            restaurant!.name!, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: textColor),
          ...
          Row(children: [
            Text('minimum_order'.tr, style: IBMPlexSansArabicRegular.copyWith(
          ...
          //   Text('cuisines'.tr +':', style: IBMPlexSansArabicRegular.copyWith(
          //     fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor,
          //   )),
              ...
              child: Center(
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                    Text('wish_list'.tr, style: IBMPlexSansArabicRegular.copyWith(fontWeight: FontWeight.w200, color: Colors.white, fontSize: Dimensions.fontSizeSmall)),
                  ],
                ),
              ),
            ) :Icon(
        ...
        child: Row(children: [
            ...
            child: Column(children: [
              Row(children: [
                ...
                Text(
                  ...
                  style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor),
                ),
              ]),
              const SizedBox(height: Dimensions.paddingSizeExtraSmall),
              Text(
                '${restaurant!.ratingCount} + ${'ratings'.tr}',
                style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor),
              ),
            ]),
          ),
          const Expanded(child: SizedBox()),
          ...
          InkWell(
            ...
            child: Column(children: [
              ...
              const SizedBox(height: Dimensions.paddingSizeExtraSmall),
              Text('location'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor)),
            ]),
          ),
          const Expanded(child: SizedBox()),
          const VerticalDivider(color: Colors.white, thickness: 1),
          ...
          Column(children: [
            ...
            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
            Text(restaurant!.deliveryTime!, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor)),
          ]),
          ...
          (restaurant!.delivery! && restaurant!.freeDelivery!) ? Column(children: [
            ...
            const SizedBox(width: Dimensions.paddingSizeExtraSmall),
            Text('free_delivery'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor)),
          ]) : const SizedBox(),
          const Expanded(child: SizedBox()),
        ]),
      ),
      ...
      //     ]),
      //     const SizedBox(width: Dimensions.paddingSizeExtraSmall),
      //     Text('delivery_time'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor)),
      //   ]),
      //   (restaurant!.delivery! && restaurant!.freeDelivery!) ? const Expanded(child: SizedBox()) : const SizedBox(),
      //   (restaurant!.delivery! && restaurant!.freeDelivery!) ? Column(children: [
      //     Icon(Icons.money_off, color: Theme.of(context).primaryColor, size: 20),
