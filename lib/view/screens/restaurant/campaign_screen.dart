                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(
                            campaignController.campaign!.title!, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                      ...
                      campaignController.campaign!.startTime != null ? Row(children: [
                        Text('campaign_schedule'.tr, style: IBMPlexSansArabicRegular.copyWith(
