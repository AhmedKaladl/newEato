                  ...
                  restaurant.discount != null ? Container(
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Text(
                        ...
                        style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).cardColor),
                      ),
                      Text(
                      ...
                      restaurant.discount!.minPurchase != 0 ? Text(
                        ...
                        style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).cardColor),
                      ) : const SizedBox(),
                          ...
                          child: Row(children: [
                            Expanded(
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Text('popular_in_this_restaurant'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w700)),
                                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                
                                Text('here_is_what_you_might_like_to_test'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                              ]),
                            ),
                ...
                delegate: SliverDelegate(height: 98, child: Center(child: Container(
                  ...
                  child: Column(children: [
                    Padding(
                      ...
                      child: Row(children: [
                        Text('all_products'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                              ...
                              Expanded(
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintStyle: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                              ...
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                Text(
                                  ...
                                  style: index == restController.categoryIndex
                                      ? IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)
                                      : IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
                                ),
                              ]),
                            ),
                          );
