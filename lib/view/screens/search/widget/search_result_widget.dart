      ...
      GetBuilder<search.SearchController>(builder: (searchController) {
        ...
        return isNull ? const SizedBox() : Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Padding(
          ...
          child: Row(children: [
            Text(
              length.toString(),
              style: IBMPlexSansArabicBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeSmall),
            ),
            ...
            Text(
              '"${widget.searchText}"',
              style: IBMPlexSansArabicBold.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color, fontSize: Dimensions.fontSizeSmall),
            ),
          ]),
        )));
      }),
