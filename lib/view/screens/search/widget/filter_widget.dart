...
class FilterWidget extends StatelessWidget {
  ...
  const FilterWidget({Key? key, required this.maxValue, required this.isRestaurant}) : super(key: key);
      ...
      child: GetBuilder<search.SearchController>(builder: (searchController) {
        return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Text('filter'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
          ...
          Flexible(
            child: SingleChildScrollView(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('sort_by'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                  ...
                  Text('filter_by'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
                  ...
                  isRestaurant ? const SizedBox() : Column(children: [
                    Text('price'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    RangeSlider(
                  ...
                  Text('rating'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                  Container(
