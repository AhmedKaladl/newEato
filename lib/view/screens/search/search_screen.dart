          ...
          return Column(children: [
            ...
            Container(
              ...
              child: Center(child: Column(
                ...
                children: [
                  ResponsiveHelper.isDesktop(context) ? Text('search_food_and_restaurant'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge)) : const SizedBox(),
              ...
              child: FooterView(
                child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  searchController.historyList.isNotEmpty ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text('recent_search'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    ...
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Text('clear_all'.tr, style: IBMPlexSansArabicRegular.copyWith(
                          ...
                          child: Row(mainAxisSize: MainAxisSize.min, children: [
                            InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  address,
                                  style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color!.withOpacity(0.5)),
                  ...
                  (_isLoggedIn && searchController.suggestedFoodList != null) ? Text(
                    'recommended'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                  ) : const SizedBox(),
                      ...
                      return (cuisineController.cuisineModel != null && cuisineController.cuisineModel!.cuisines!.isEmpty) ? const SizedBox() : Column(
                        ...
                        children: [
                          (cuisineController.cuisineModel != null) ? Text(
                            'cuisines'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                          ) : const SizedBox(),
                          const SizedBox(height: Dimensions.paddingSizeDefault),
