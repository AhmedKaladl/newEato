      ...
      return (foodList != null && foodList.isEmpty) ? const SizedBox() : Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(isPopular ? 'popular_foods_nearby'.tr : 'best_reviewed_food'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: 24)),
          ),

          foodList != null ? GridView.builder(
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              crossAxisCount: 4, childAspectRatio: (1/0.36),
