          ...
          Stack(children: [
            ClipRRect(
              ...
              child: CustomImage(
                ...
                height: context.width * 0.2, width: Dimensions.webMaxWidth, fit: BoxFit.cover,
              )
            ),
            DiscountTag(
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  SizedBox(height: restaurant!.address != null ? 1 : 0),

                  RatingBar(
                    rating: restaurant!.avgRating, size: desktop ? 17 : 17,
