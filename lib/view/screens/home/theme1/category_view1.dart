                              ...
                              child: Stack(children: [
                                ClipRRect(
                                  ...
                                  child: CustomImage(
                                    ...
                                    height: 95, width: 152, fit: BoxFit.cover,
                                  ),
                                ),
                                Positioned(bottom: 0, left: 0, right: 0, child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    color: const Color(0xFF03041D).withOpacity(0.4),
                                  ),
                                  child: Text(
                                    categoryController.categoryList![index].name!, maxLines: 1, overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.center,
                                    style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Colors.white),
                                  ),
                                )),
                              ]),
                            ),
