  ...
  Widget build(BuildContext context) {
    return GetBuilder<RestaurantController>(builder: (restaurantController) {
      ...
      return (restaurant != null && restaurant.isEmpty) ? const SizedBox() : Column(
        children: [
          Padding(
            padding: EdgeInsets.fromLTRB(10, isPopular ? 30 : 30, 10, 10),
            child: TitleWidget(
                        ...
                        Stack(children: [
                          ClipRRect(
                            ...
                            child: CustomImage(
                              ...
                              height: 110, width: 300, fit: BoxFit.cover,
                            ),
                          ),
                          DiscountTag(
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                              ...
                              Text(
                                '${'prossesing_time'.tr} ${restaurant[index].deliveryTime ?? ''} ${'min'.tr}',
                                style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).secondaryHeaderColor),
                                maxLines: 1,
                              ...
                              //Text('delivery_charge'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall),),
                              //const SizedBox(height: Dimensions.paddingSizeExtraSmall),
