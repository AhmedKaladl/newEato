...
class RestaurantDetailsSheet extends StatelessWidget {
  ...
  const RestaurantDetailsSheet({Key? key, required this.callback}) : super(key: key);
            ...
            child: Container(
              ...
              child: Column(children: [
                ...
                Stack(children: [
                  ...
                  ClipRRect(borderRadius: BorderRadius.circular(Dimensions.radiusDefault), child: CustomImage(
                ...
                Row(children: [
                  ...
                  Expanded(child: Text(restaurant.name!, maxLines: 1, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeDefault))),

                  Icon(Icons.star, color: Theme.of(context).primaryColor, size: 18),
                  Text(
                    restaurant.avgRating!.toStringAsFixed(1),
                    style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeDefault),
                  ),
                  Text('(${restaurant.ratingCount})', style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor)),
                ]),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                Row(children: [
                  ...
                  )/1000).toStringAsFixed(1)} ${'km'.tr}', style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                  ...
                  restaurant.freeDelivery! ?  Row(children: [
                    ...
                    Text('free'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                  ]) : const SizedBox(),
