                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: IBMPlexSansArabicMedium.copyWith(fontWeight: FontWeight.w600),
                      ),
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                        ...
                        isNewOnStackFood! ? restaurant.freeDelivery! ? ImageWithTextRowWidget(
                          ...
                          text: 'free'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
                        ...
                        isNewOnStackFood! ? ImageWithTextRowWidget(
                          ...
                          style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
                           ...
                           text: 'free'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)) : const SizedBox(),
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            ...
                            style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor),
                          ),
                          Text('items'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: 10, color: Theme.of(context).primaryColor)),
                        ],
                      ),
                    ),
                  ),
