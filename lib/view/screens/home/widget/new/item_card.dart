        ...
        child: Column(children: [
          ...
          Expanded(
            ...
            child: Padding(
              ...
              children: [
                Text(
                  product.restaurantName!, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall),
                ...
                Wrap(crossAxisAlignment: WrapCrossAlignment.center,
                  children: [
                    Text(product.name!, style: IBMPlexSansArabicMedium, overflow: TextOverflow.ellipsis, maxLines: 1),
                ...
                Row(
                  ...
                  children: [
                    Text(product.avgRating!.toStringAsFixed(1), style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                    Icon(Icons.star, color: Theme.of(context).primaryColor, size: 18),
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                    Text('(${product.ratingCount})', style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor)),
                  ],
                ),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                ...
                Row(
                  ...
                  children: [
                    discountPrice < price ? Text(PriceConverter.convertPrice(price),
                        style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor, decoration: TextDecoration.lineThrough)): const SizedBox(),
                    discountPrice < price ? const SizedBox(width: Dimensions.paddingSizeExtraSmall) : const SizedBox(),

                    Text(PriceConverter.convertPrice(discountPrice), style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeSmall)),
                  ],
                ),
      ...
      /*child: Stack(
        children: [
                    ...
                    children: [
                      ...
                      Wrap(crossAxisAlignment: WrapCrossAlignment.center,
                        children: [
                          SizedBox(
                            width: 130,
                            child: Text(product.name!, style: IBMPlexSansArabicMedium, overflow: TextOverflow.ellipsis, maxLines: 1),
                          ),
                          const SizedBox(width: Dimensions.paddingSizeExtraSmall),
          ...
          Positioned(
           ...
           //          Text('free'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: 9)),
           //        ],
           //      ),
           //    )),
