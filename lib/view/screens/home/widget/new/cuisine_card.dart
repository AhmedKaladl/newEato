...
class CuisineCard extends StatelessWidget {
  final String image;
  final String name;
  const CuisineCard({Key? key, required this.image, required this.name}) : super(key: key);
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Text( name, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall),
