          ...
          child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Padding(
                  ...
                  child: Text('today_trends'.tr, style: IBMPlexSansArabicBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge)),
                ),
                ...
                Padding(
                  ...
                  child: Text('here_what_you_might_like_to_taste'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).primaryColor.withOpacity(0.5))),
                ),
