    ...
    return GetBuilder<CategoryController>(builder: (categoryController) {
          return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Padding(
              ...
              child: ResponsiveHelper.isDesktop(context) ? Text('what_on_your_mind'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w600)) :
              Padding(padding: const EdgeInsets.only(left: Dimensions.paddingSizeSmall, right: Dimensions.paddingSizeDefault),
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                       Text('what_on_your_mind'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w600)),
