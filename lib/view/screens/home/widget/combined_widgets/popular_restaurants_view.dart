            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                ResponsiveHelper.isDesktop(context) ? Padding(
                  ...
                  child: Text(isRecentlyViewed ? 'your_restaurants'.tr : 'popular_restaurants'.tr,
                    style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w600),
                  ),
                ) : Padding(
                              ...
                              children: [
                                ...
                                !isAvailable ? Positioned(top: 30, left: 60, child: Container(
                                  ...
                                  child: Row(children: [
                                    ...
                                    Text('closed_now'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeSmall)),
                                  ]),
                                )) : const SizedBox(),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(restaurantList[index].name!,
                                          overflow: TextOverflow.ellipsis, maxLines: 1, style: IBMPlexSansArabicMedium.copyWith(fontWeight: FontWeight.w600)),
