            ...
            child: Column(
              ...
              children: [
                ResponsiveHelper.isDesktop(context) ?  Padding(
                  ...
                  child: Text('popular_foods_nearby'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text('popular_foods_nearby'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
