          ...
          Expanded(
              child: Row(children: [
                ...
                Column(
                  ...
                  children: [
                    Text('find_nearby'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: ResponsiveHelper.isMobile(context) ? Dimensions.fontSizeDefault : Dimensions.fontSizeExtraLarge, fontWeight: FontWeight.w600)),
                    const SizedBox(height: Dimensions.paddingSizeSmall),

                    Text('restaurant_near_from_you'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: ResponsiveHelper.isMobile(context) ? Dimensions.fontSizeSmall : Dimensions.fontSizeLarge)),
                  ],
                ),
              ],
              ),
