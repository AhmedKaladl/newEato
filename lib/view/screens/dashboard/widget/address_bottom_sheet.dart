            ...
            Flexible(
              child: SingleChildScrollView(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text('${'hey_welcome_back'.tr}\n${'which_location_do_you_want_to_select'.tr}', style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                  ...
                  Align(
                    ...
                    child: TextButton.icon(
                      ...
                      label: Text('use_current_location'.tr, style: IBMPlexSansArabicMedium.copyWith(color: locationController.addressList != null && locationController.addressList!.isEmpty
                          ? Theme.of(context).cardColor : Theme.of(context).primaryColor)),
                    ),
                  ),
                  ...
                  locationController.addressList != null && locationController.addressList!.isNotEmpty ? TextButton.icon(
                    ...
                    label: Text('add_new_address'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor)),
                  ) : const SizedBox(),
