        ...
        child: GetBuilder<AuthController>(
          builder: (authController) {
            return Column(
              ...
              children: [
                Text('estimated_delivery_time'.tr , style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeLarge,color: Theme.of(context).disabledColor),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                  ...
                  Text(':', style: IBMPlexSansArabicBold),
