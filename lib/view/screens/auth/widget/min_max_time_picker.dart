        ...
        itemBuilder: (context, index, _) {
          return Container(
            ...
            child: Center(child: Text(
              ...
              style: selectedIndex == index ? IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge) : IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
            )),
          );
        },
      ),
