      ...
      return Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Row(children: [
          ...
          TextButton(
            ...
            child: Text('${'forgot_password'.tr}?', style: IBMPlexSansArabicRegular.copyWith( fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor)),
          ),
        ]),
        ...
        !ResponsiveHelper.isDesktop(context) ? Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Text('do_not_have_account'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).hintColor)),
          ...
          InkWell(
            ...
            child: Padding(
              ...
              child: Text('sign_up'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor)),
            ),
          ),
        ]) : const SizedBox(),
