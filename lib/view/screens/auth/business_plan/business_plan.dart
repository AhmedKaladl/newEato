                      ...
                      child: Center(
                        child: Column(children: [
                          ...
                          authController.businessPlanStatus != 'payment' ? Column(children: [
                            ...
                            Center(child: Text('choose_your_business_plan'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeDefault))),
                            ...
                            authController.businessIndex == 0 ? Padding(
                              ...
                              child: Text(
                                ...
                                style: IBMPlexSansArabicRegular, textAlign: TextAlign.start, textScaleFactor: 1.1,
                              ),
                            ) : Column(children: [
                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge),
                                child: Text(
                                  ...
                                  style: IBMPlexSansArabicRegular, textAlign: TextAlign.start,
                                ),
                              ),
                                ...
                                child: (authController.packageModel!.packages!.isNotEmpty && authController.packageModel!.packages!.isNotEmpty) ? Swiper(
                                  ...
                                  itemBuilder: (BuildContext context, int index){
                                    ...
                                    children: [
                                      ...
                                      Text('no_package_available'.tr, style: IBMPlexSansArabicMedium),
                                    ]),
                                ),
                ...
                SizedBox(
                  ...
                  child: SafeArea(
                    child: Padding(
                      ...
                      child: !authController.isLoading ? Row(children: [
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                Text("back".tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeLarge),),
                              ]),
                            ),
                          ),
                        ) : const SizedBox(),
        ...
        return Stack( clipBehavior: Clip.none, children: [
            InkWell(
              ...
              child: Container(
                ...
                child: Text(title, style: IBMPlexSansArabicBold.copyWith(color: authController.paymentIndex == index ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge!.color)),
              ),
            ),
    ...
    return InkWell(
      ...
      child: Stack(clipBehavior: Clip.none, children: [
        ...
        Container(
          ...
          child: Center(child: Text(title, style: IBMPlexSansArabicMedium.copyWith(color: authController.businessIndex == index ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge!.color, fontSize: Dimensions.fontSizeDefault))),
        ),
