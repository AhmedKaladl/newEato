  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      Text(
        ...
        style: IBMPlexSansArabicBold.copyWith(fontSize: 35, color: color),
      ),

      Text('${package.validity} ' 'days'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeSmall)),
      const SizedBox(height: Dimensions.paddingSizeDefault),
    ...
    return Column(children: [
      Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
          ...
          Text(title.tr, style: IBMPlexSansArabicMedium),
        ]),
      ),
