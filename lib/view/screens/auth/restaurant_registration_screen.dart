      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            Row(children: [
              Container(
                ...
                child: TabBar(
                  ...
                  unselectedLabelStyle: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall),
                  labelStyle: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor),
        ...
        Container(
          ...
          child: Column(children: [
            ...
            Row(children: [
              ...
              Text('general_information'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall))
            ]),
            const Divider(),
            const SizedBox(height: Dimensions.paddingSizeLarge),
              ...
              Expanded(child: Column(mainAxisSize: MainAxisSize.min, children: [
                Row(children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('delivery_time'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                ...
                authController.zoneList != null ? const SelectLocationView(fromView: true, zoneCuisinesView: true,) : const Center(child: CircularProgressIndicator()),
              ])),
        ...
        Container(
          ...
          child: Column(children: [
            Row(children: [
              const Icon(Icons.person),
              Text('owner_information'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall))
            ]),
            const Divider(),
            const SizedBox(height: Dimensions.paddingSizeLarge),
        ...
        Container(
          ...
          child: Column(children: [
            Row(children: [
              ...
              Text('login_info'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall))
            ]),
            const Divider(),
            const SizedBox(height: Dimensions.paddingSizeLarge),
