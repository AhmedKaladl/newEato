                            ...
                            child: authController.pickedImage != null ? GetPlatform.isWeb ? Image.network(
                              ...
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                Text(
                                  ...
                                  style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center,
                                ),
                              ]),
                            ),
                          ),
                                ...
                                child: DottedBorder(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                      ...
                                      Text('upload_identity_image'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).disabledColor)),
                                    ]),
                                  ),
                                ),
                              );
              ...
              SizedBox(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                  ...
                  Container(
                    ...
                    padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                    child: Column(children: [
                      Text('delivery_man_registration'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                      const SizedBox(height: Dimensions.paddingSizeSmall),
                        ...
                        ClipRRect(
                          ...
                          child: authController.pickedImage != null ? GetPlatform.isWeb ? Image.network(
                            ...
                            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                              ...
                              Text(
                                'upload_deliveryman_photo'.tr,
                                style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).disabledColor), textAlign: TextAlign.center,
                              ),
                            ]),
                          ),
                        ),
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      Row(children: [
                        ...
                        const SizedBox(width: Dimensions.paddingSizeSmall),
                        Text('delivery_man_information'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall))
                      ]),
                      const Divider(),
                      const SizedBox(height: Dimensions.paddingSizeLarge),
                      ...
                      Row(children: [
                        Expanded(child: Column(
                          ...
                          children: [
                            Text('delivery_man_type'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                        ...
                        Expanded(child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('zone'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                            const SizedBox(height: Dimensions.paddingSizeDefault),
                        ...
                        Expanded(child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('vehicle_type'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                            const SizedBox(height: Dimensions.paddingSizeDefault),
                      ...
                      Row(children: [
                        Expanded(child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('identity_type'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                            const SizedBox(height: Dimensions.paddingSizeDefault),
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Text('upload_identity_image'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).disabledColor), textAlign: TextAlign.center),
                                      ],
                                    ),
                                  ),
                                ),
