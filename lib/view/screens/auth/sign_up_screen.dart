              ...
              return SingleChildScrollView(
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Align(
                    ...
                    child: Text('sign_up'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                  ),
              ...
              return SingleChildScrollView(
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Text('already_have_account'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).hintColor)),
                    ...
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Text('sign_in'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor)),
                      ),
                    ),
                  ]),
