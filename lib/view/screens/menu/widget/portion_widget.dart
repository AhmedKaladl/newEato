      ...
      child: Container(
        ...
        child: Column(children: [
          Row(children: [
            ...
            Expanded(child: Text(title, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeDefault))),
            ...
            suffix != null ? Container(
              ...
              child: Text(suffix!, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor)),
            ) : const SizedBox(),
          ]),
