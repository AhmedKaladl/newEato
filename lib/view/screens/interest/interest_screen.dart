          ...
          return categoryController.categoryList != null ? categoryController.categoryList!.isNotEmpty ? Center(
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('choose_your_interests'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: 22)),
                const SizedBox(height: Dimensions.paddingSizeSmall),

                Text('get_personalized_recommendations'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).disabledColor)),
                const SizedBox(height: Dimensions.paddingSizeLarge),
