...
class PaymentButton extends StatelessWidget {
  ...
  final int index;
  const PaymentButton({Key? key, required this.index, required this.icon, required this.title, required this.subtitle}) : super(key: key);
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: Row(children: [
              ...
              Text(title, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeSmall, color: selected ? Theme.of(context).primaryColor : Theme.of(context).disabledColor)),
