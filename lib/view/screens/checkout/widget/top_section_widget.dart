            ...
            return Column(children: [
              ...
              isCashOnDeliveryActive && restaurantSubscriptionActive ? Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('order_type'.tr, style: IBMPlexSansArabicMedium),
              ...
              restController.restaurant != null ? Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text('delivery_option'.tr, style: IBMPlexSansArabicMedium),
                  ...
                  SingleChildScrollView(scrollDirection: Axis.horizontal, child: Row(children: [
                    ...
                    (Get.find<SplashController>().configModel!.homeDelivery! && restController.restaurant!.delivery!)
                        ? DeliveryOptionButton(
                      value: 'wdelivery', title: 'woman_delivery'.tr, charge: charge,
                      isFree: restController.restaurant!.freeDelivery, total: total,
                    ) : const SizedBox(),
                    const SizedBox(width: Dimensions.paddingSizeDefault),
              ...
              (orderController.orderType != 'take_away' && !ResponsiveHelper.isDesktop(context)) ? Center(child: Text('${'delivery_charge'.tr}: '
                  '${(orderController.orderType == 'take_away' || (orderController.orderType == 'delivery' || orderController.orderType == 'wdelivery'
                  ? restController.restaurant!.freeDelivery! : true)) ? 'free'.tr : charge != -1 ? PriceConverter.convertPrice(orderController.orderType == 'delivery'
                  || orderController.orderType == 'wdelivery' ? charge : deliveryCharge) : 'calculating'.tr}', textDirection: TextDirection.ltr)) : const SizedBox(),
              ...
              orderController.orderType != 'take_away' ? Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text('deliver_to'.tr, style: IBMPlexSansArabicMedium),
                    InkWell(
                      onTap: () async{
