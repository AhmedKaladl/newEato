...
class SubscriptionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Row(children: [
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('subscription_type'.tr, style: IBMPlexSansArabicMedium),
        ...
        ResponsiveHelper.isDesktop(context) ? Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('subscription_date'.tr, style: IBMPlexSansArabicMedium),
          const SizedBox(height: Dimensions.paddingSizeSmall),
      ...
      orderController.subscriptionType != 'daily' ? Text('days'.tr, style: IBMPlexSansArabicMedium) : Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text('subscription_schedule'.tr, style: IBMPlexSansArabicMedium),
        InkWell(
          onTap: () async {
      ...
      SizedBox(height: orderController.subscriptionType != 'daily' ? Dimensions.paddingSizeSmall : 0),

      orderController.subscriptionType != 'daily' ? SizedBox(child: GridView.builder(
          key: UniqueKey(),
              ...
              child: Container(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  Text(
                    ...
                    style: IBMPlexSansArabicRegular.copyWith(color: isSelected ? Colors.white : Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall),
                  ),
                  ...
                  isSelected ? Text(
                    ...
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: IBMPlexSansArabicRegular.copyWith(color: isSelected ? Colors.white : Theme.of(context).hintColor, fontSize: Dimensions.fontSizeExtraSmall),
                  ) : const SizedBox(),
                ]),
              ),
            );
