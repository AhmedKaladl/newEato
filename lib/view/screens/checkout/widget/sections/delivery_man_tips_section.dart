      ...
      children: [
        (!widget.orderController.subscriptionOrder && !widget.takeAway && Get.find<SplashController>().configModel!.dmTipsStatus == 1) ? Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Text('delivery_man_tips'.tr, style: IBMPlexSansArabicMedium),
              ...
              JustTheTooltip(
                ...
                content: Padding(
                  ...
                  child: Text('it_s_a_great_way_to_show_your_appreciation_for_their_hard_work'.tr,style: IBMPlexSansArabicRegular.copyWith(color: Colors.white)),
                ),
                child: InkWell(
              ...
              (widget.orderController.selectedTips == AppConstants.tips.length-1) ? const SizedBox() : SizedBox(
                ...
                child: ListTile(
                  ...
                  title: Text('save_for_later'.tr, style: IBMPlexSansArabicMedium.copyWith(color: isDesktop ? Theme.of(context).textTheme.bodyMedium!.color! : Theme.of(context).primaryColor)),
