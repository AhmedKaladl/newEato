    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        ResponsiveHelper.isDesktop(context) ? Padding(
          ...
          child: Text('order_summary'.tr, style: IBMPlexSansArabicBold),
        ) : const SizedBox(),
        ...
        !ResponsiveHelper.isDesktop(context) ? Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('additional_note'.tr, style: IBMPlexSansArabicMedium),
            const SizedBox(height: Dimensions.paddingSizeSmall),
              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  PriceConverter.convertAnimationPrice(
                    total,
                    textStyle: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor),
                  ),
                ]),
              ),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        !ResponsiveHelper.isDesktop(context) ? Column(children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('order_summary'.tr, style: IBMPlexSansArabicMedium),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text(!orderController.subscriptionOrder ? 'subtotal'.tr : 'item_price'.tr, style: IBMPlexSansArabicRegular),
          Text(PriceConverter.convertPrice(subTotal), style: IBMPlexSansArabicRegular, textDirection: TextDirection.ltr),
        ]),
        const SizedBox(height: Dimensions.paddingSizeSmall),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          Row(children: [
            Text('(-) ', style: IBMPlexSansArabicRegular),
            PriceConverter.convertAnimationPrice(discount, textStyle: IBMPlexSansArabicRegular)
          ]),
        ...
        (couponController.discount! > 0 || couponController.freeDelivery) ? Column(children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            (couponController.coupon != null && couponController.coupon!.couponType == 'free_delivery') ? Text(
              'free_delivery'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).primaryColor),
            ) : Row(children: [
              Text('(-) ', style: IBMPlexSansArabicRegular),
              Text(
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Row(children: [
            Text('${'vat_tax'.tr} ${taxIncluded ? 'tax_included'.tr : ''}', style: IBMPlexSansArabicRegular),
            Text('($taxPercent%)', style: IBMPlexSansArabicRegular, textDirection: TextDirection.ltr),
          ]),
          Row(children: [
            Text('(+) ', style: IBMPlexSansArabicRegular),
        ...
        (orderController.orderType != 'take_away' && Get.find<SplashController>().configModel!.dmTipsStatus == 1 && !orderController.subscriptionOrder) ? Row(
          ...
          children: [
            ...
            Row(children: [
              Text('(+) ', style: IBMPlexSansArabicRegular),
              PriceConverter.convertAnimationPrice(orderController.tips, textStyle: IBMPlexSansArabicRegular)
            ]),
            // Text('(+) ${PriceConverter.convertPrice(orderController.tips)}', style: IBMPlexSansArabicRegular, textDirection: TextDirection.ltr),
          ],
        ...
        orderController.orderType != 'take_away' ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          orderController.distance == -1 ? Text(
            'calculating'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Colors.red),
          ) : (deliveryCharge == 0 || (couponController.coupon != null && couponController.coupon!.couponType == 'free_delivery')) ? Text(
            'free'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).primaryColor),
          ) : Row(children: [
            Text('(+) ', style: IBMPlexSansArabicRegular),
            Text(
              PriceConverter.convertPrice(deliveryCharge), style: IBMPlexSansArabicRegular, textDirection: TextDirection.ltr,
            )
          ]),
        ]) : const SizedBox(),
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text(
                ...
                style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: orderController.isPartialPay ? Theme.of(context).textTheme.bodyMedium!.color : Theme.of(context).primaryColor),
              ),
              PriceConverter.convertAnimationPrice(
                total,
                textStyle: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: orderController.isPartialPay ? Theme.of(context).textTheme.bodyMedium!.color : Theme.of(context).primaryColor),
              ),
            ]),
          ],
        ) : const SizedBox(),
        ...
        orderController.subscriptionOrder ? Column(children: [
          const SizedBox(height: Dimensions.paddingSizeSmall),
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('subscription_order_count'.tr, style: IBMPlexSansArabicMedium),
            Text(/*subscriptionQty > 0 ? */subscriptionQty.toString()/* : 'calculating'.tr*/, style: IBMPlexSansArabicMedium),
          ]),
          Padding(
            padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall),
        ...
        orderController.isPartialPay && !orderController.subscriptionOrder ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text('paid_by_wallet'.tr, style: IBMPlexSansArabicRegular),
          Text('(-) ${PriceConverter.convertPrice(Get.find<UserController>().userInfoModel!.walletBalance!)}', style: IBMPlexSansArabicRegular, textDirection: TextDirection.ltr),
        ]) : const SizedBox(),
        SizedBox(height: orderController.isPartialPay ? Dimensions.paddingSizeSmall : 0),
        ...
        orderController.isPartialPay && !orderController.subscriptionOrder ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text(
            'due_payment'.tr,
            style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: !ResponsiveHelper.isDesktop(context) ? Theme.of(context).textTheme.bodyMedium!.color : Theme.of(context).primaryColor),
          ),
          PriceConverter.convertAnimationPrice(
            orderController.viewTotalPrice,
            textStyle: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: !ResponsiveHelper.isDesktop(context) ? Theme.of(context).textTheme.bodyMedium!.color : Theme.of(context).primaryColor),
          )
        ]) : const SizedBox(),
