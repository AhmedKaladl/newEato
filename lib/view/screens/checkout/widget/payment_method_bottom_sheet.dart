                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Align(alignment: Alignment.center, child: Text('payment_method'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge))),
                      ...
                      Flexible(
                        child: SingleChildScrollView(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                            ...
                            !widget.isSubscriptionPackage && notHideCod ? Text('choose_payment_method'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeDefault)) : const SizedBox(),
                            ...
                            widget.isDigitalPaymentActive && notHideDigital && !orderController.subscriptionOrder ? Row(children: [
                              Text('pay_via_online'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                              Text(
