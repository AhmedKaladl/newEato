          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Text(
                ...
                style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall),
      ...
      ResponsiveHelper.isDesktop(context) ? Positioned(
        ...
        child: JustTheTooltip(
          ...
          content: Padding(
            ...
            child: Text('code_copied'.tr,style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).primaryColor)),
          ),
          child: InkWell(
            onTap: () async {
