...
import 'package:efood_multivendor/view/screens/chat/widget/web_conversation_list_view.dart';
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('messages'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                              ...
                              children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Row(children: [
                                              ...
                                              Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                ...
                                                Text(
                                                  '${Get.find<SplashController>().configModel!.businessName}', style: IBMPlexSansArabicMedium,
                                                ),
                                ...
                                Align(
                                  ...
                                  child: TabBar(
                                    ...
                                    labelStyle: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeDefault),
                                    unselectedLabelStyle: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeDefault),
                                    tabs: [
                                      Tab(text: 'vendor'.tr),
                                ...
                                Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Flexible(
                                        child: Text(
                                          widget.chatController.notificationBody!.name!, style: IBMPlexSansArabicMedium, maxLines: 1, overflow: TextOverflow.ellipsis,
                                        ),
                                      ),

                                      Text('(${widget.chatController.notificationBody!.receiverType!.tr})', style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor)),
                                    ],
                                  ),
                                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                    ...
                                    children: [
                                      ...
                                      TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintStyle: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall),
                                        ),
