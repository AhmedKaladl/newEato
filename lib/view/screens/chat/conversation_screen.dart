...
import 'package:efood_multivendor/view/screens/chat/widget/web_chat_view.dart';
    ...
    return GetBuilder<ChatController>(builder: (chatController) {
      ...
      return Scaffold(
        ...
        floatingActionButton: (chatController.conversationModel != null && !chatController.hasAdmin) && !ResponsiveHelper.isDesktop(context) ? FloatingActionButton.extended(
          // label: Text('${'chat_with'.tr} ${AppConstants.appName}', style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.white)),
          label: SizedBox(
            width: context.width * 0.75,
            child: Text(
              '${'chat_with'.tr} ${Get.find<SplashController>().configModel!.businessName}',
              maxLines: 2, overflow: TextOverflow.ellipsis,
              style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.white),
            ),
          ),
                            ...
                            child: Stack(children: [
                              Padding(
                                ...
                                child: Row(children: [
                                  ...
                                  Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    user != null ? Text(
                                      '${user.fName} ${user.lName}', style: IBMPlexSansArabicMedium,
                                    ) : Text('${type!.tr} ${'deleted'.tr}', style: IBMPlexSansArabicMedium),
                              ...
                              Positioned(
                                ...
                                child: Text(
                                  ...
                                  style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeExtraSmall),
                                ),
                              ),
                                ...
                                return (userController.userInfoModel != null && userController.userInfoModel!.userInfo != null
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      ...
                                      style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeExtraSmall),
                                    ),
                                  ),
                                ) : const SizedBox();
                              }),
