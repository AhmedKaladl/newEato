    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          ) : Text('search_location'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).disabledColor)),
          const SizedBox(width: Dimensions.paddingSizeExtraSmall),

          Expanded(
            child: (pickedAddress != null && pickedAddress!.isNotEmpty) ? Text(
              pickedAddress!,
              style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeLarge), maxLines: 1, overflow: TextOverflow.ellipsis,
            ) : Text(
              hint ?? '',
              style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor),
