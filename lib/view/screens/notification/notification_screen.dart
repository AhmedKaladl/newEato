                              ...
                              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Expanded(
                                      child: Text(
                                        ...
                                        style: isSeen ? IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall) : IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeSmall),
                                      ),
                                    ),
                                  ...
                                  Text(
                                    ...
                                    style: isSeen ? IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall) : IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall),
                                  ),
                                ])),
