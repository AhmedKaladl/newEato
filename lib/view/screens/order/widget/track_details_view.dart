...
class TrackDetailsView extends StatelessWidget {
  ...
  const TrackDetailsView({Key? key, required this.track, required this.callback}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: (!takeAway && track.deliveryMan == null) ? Padding(
        padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
        child: Text(
          'delivery_man_not_assigned'.tr, style: IBMPlexSansArabicMedium, textAlign: TextAlign.center,
        ),
      ) : Column(children: [

        Text('trip_route'.tr, style: IBMPlexSansArabicMedium),
        ...
        Row(children: [
          ...
          Expanded(flex: 3, child: Text(
            ...
            style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeDefault),
          ...
          Expanded(
              flex: 5,
              child: takeAway ? Text(track.restaurant != null ? track.restaurant!.address! : '', style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeDefault),
        ...
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            RatingBar(
              rating: takeAway ? track.restaurant != null ? track.restaurant!.avgRating : 0 : track.deliveryMan!.avgRating, size: 12,
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Icon(Icons.phone, size: 26, color: Theme.of(context).cardColor),
            ),
          ),
          const SizedBox(width: Dimensions.paddingSizeSmall),
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Icon(Icons.chat_bubble, size: 26, color: Theme.of(context).cardColor),
            ),
          ),
