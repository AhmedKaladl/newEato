...
class LogDialog extends StatefulWidget {
  ...
  const LogDialog({Key? key, required this.subscriptionID, required this.isDelivery}) : super(key: key);
          ...
          Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Expanded(child: GetBuilder<OrderController>(builder: (orderController) {
                ...
                return notNull ? length! > 0 ? PaginatedListView(
                      ...
                      return Column(children: [
                        ...
                        Row(children: [
                          ...
                          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Row(children: [
                              Text('${index + 1})  ', style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                          ...
                          widget.isDelivery ? Container(
                            ...
                            child: Text(
                              ...
                              style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeExtraSmall),
                            ),
                          ) : const SizedBox(),
