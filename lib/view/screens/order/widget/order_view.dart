  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
                  ...
                  children: [
                    GridView.builder(
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        childAspectRatio: ResponsiveHelper.isDesktop(context) ? 5 : 3.4,
                              ...
                              Row(children: [
                                ...
                                Expanded(
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Row(children: [
                                      Text('${'order_id'.tr}:', style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                      Text('#${orderList[index].id}', style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                    ]),
                                    const SizedBox(height: Dimensions.paddingSizeSmall),

                                    ResponsiveHelper.isDesktop(context) ? Text(orderList[index].orderStatus!.tr, style: IBMPlexSansArabicMedium.copyWith(
                                    ...
                                    Text(
                                      ...
                                      style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall),
                                    ),
                                  ]),
                                ),
                                const SizedBox(width: Dimensions.paddingSizeSmall),
                                ...
                                Row(crossAxisAlignment: CrossAxisAlignment.end, mainAxisAlignment: MainAxisAlignment.center, children: [
                                  ...
                                  isRunning || isSubscription ? Column(children: [
                                    ...
                                    !ResponsiveHelper.isDesktop(context) ? Container(
                                      ...
                                      child: Text(orderList[index].orderStatus!.tr, style: IBMPlexSansArabicMedium.copyWith(
                                        fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor,
                                      )),
                                    ) : const SizedBox(),
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(children: [
                                          Text('track_order'.tr, style: IBMPlexSansArabicMedium.copyWith(
                                    ...
                                    style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall),
                                  ),
                                ]),
        ...
        ) : SingleChildScrollView(child: FooterView(child: NoDataScreen(title: 'no_order_found'.tr))) : OrderShimmer(orderController: orderController);
      }),
    );
  }
}
