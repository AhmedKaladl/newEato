    ...
    return Column(children: [
      !orderController.showCancelled ? Center(
          ...
          child: Row(children: [
            ...
            : (pending)) ? Expanded(child: Padding(
              ...
              child: TextButton(
                ...
                child: Text(subscription ? 'cancel_subscription'.tr : 'cancel_order'.tr, style: IBMPlexSansArabicBold.copyWith(
        ...
        child: Container(
          ...
          child: Text('order_cancelled'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor)),
        ),
      ),
