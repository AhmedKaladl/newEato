        ...
        Padding(
          ...
          child: Column(children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              ) : Text('free'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).primaryColor)),
            ]),
            ...
            order.paymentMethod == 'partial_payment' ? Container(
                ...
                child: Column(children: [
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Text(
                      ...
                      style: IBMPlexSansArabicMedium.copyWith(fontSize: ResponsiveHelper.isDesktop(context) ? Dimensions.fontSizeSmall : Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor),
                    ),
                  ]),
                  const SizedBox(height: 10),

                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text('paid_by_wallet'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                    Text(
              ...
              Text(subscription ? 'subtotal'.tr : 'total_amount'.tr, style: IBMPlexSansArabicMedium.copyWith(
            ...
            subscription ? Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text(order.subscription!.quantity.toString(), style: IBMPlexSansArabicMedium),
              ]),
              Padding(
                padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall),
                child: Divider(thickness: 1, color: Theme.of(context).hintColor.withOpacity(0.5)),
