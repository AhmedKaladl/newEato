              ...
              itemBuilder: (context, index) {
                return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text(
                    ...
                    style: IBMPlexSansArabicMedium.copyWith(fontSize: context.height*0.022, color: Theme.of(context).primaryColor),
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: IBMPlexSansArabicRegular.copyWith(fontSize: context.height*0.015, color: Theme.of(context).disabledColor),
                      textAlign: TextAlign.center,
                    ),
                  ),
