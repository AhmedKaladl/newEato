                    ...
                    Container(
                      ...
                      child: Align(
                        ...
                        child: Padding(
                          ...
                          child: Text('profile'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge)))),
                    ),
                      ...
                      child: Align(
                        ...
                        child: InkWell(
                          ...
                          child: Row(mainAxisSize: MainAxisSize.min, children: [
                              ...
                              Text('delete_account'.tr , style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                            ],
                          ))),
                    ),
                  ...
                  child: Container(
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Text(
                        ...
                        style: IBMPlexSansArabicMedium.copyWith(fontSize: ResponsiveHelper.isDesktop(context) ? Dimensions.fontSizeDefault : Dimensions.fontSizeExtraLarge),
                      ),
                      const SizedBox(height: Dimensions.paddingSizeSmall),
                      Text('since_joining'.tr, style: IBMPlexSansArabicRegular.copyWith(
