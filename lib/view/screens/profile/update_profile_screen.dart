            ...
            Expanded(child: Scrollbar(child: SingleChildScrollView(
              ...
              child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  ...
                  Text('(${'non_changeable'.tr})', style: IBMPlexSansArabicRegular.copyWith(
                    ...
                    Container(
                      ...
                      child: Align(
                          ...
                          child: Padding(
                              ...
                              child: Text('edit_profile'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge)))),
                    ),
