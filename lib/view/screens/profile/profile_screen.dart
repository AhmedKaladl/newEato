...
import 'package:efood_multivendor/view/screens/profile/widget/web_profile_widget.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: ResponsiveHelper.isDesktop(context) ? Theme.of(context).colorScheme.background : Theme.of(context).cardColor,
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              Text('profile'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                            ...
                            child: Row(children: [
                                  ...
                                  isLoggedIn ? Text(
                                    ...
                                    onTap: () async {
                                      if(!ResponsiveHelper.isDesktop(context)) {
                                        ...
                                        Get.dialog(const Center(child: AuthDialog(exitFromApp: false, backFromThis: false))).then((value) {
                                          initCall();
                                          setState(() {});
                                        });
                                      }
                              ...
                              isLoggedIn ? InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    'login'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).cardColor),
                                  ),
                                ),
                              )
