                ...
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: Column(children: [
                      ...
                      Text('how_we_can_help_you'.tr, style: IBMPlexSansArabicBold.copyWith(
                        fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).cardColor,
                      )),
                      const SizedBox(height: Dimensions.paddingSizeSmall),

                      Text('hey_let_us_know_your_problem'.tr, style: IBMPlexSansArabicRegular.copyWith(
  ...
  Widget element(BuildContext context,{required String image, required String title, required String subTitle, required Function() onTap}){
    return InkWell(
      ...
      child: Column(children: [
        ...
        Text(
          subTitle,
          style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor),
        ),
