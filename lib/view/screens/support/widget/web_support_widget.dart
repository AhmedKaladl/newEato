    ...
    return SizedBox(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(children: [
                      ...
                      Text('how_we_can_help_you'.tr, style: IBMPlexSansArabicBold.copyWith( fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).cardColor,
                      )),
                      const SizedBox(height: Dimensions.paddingSizeSmall),

                      Text('hey_let_us_know_your_problem'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor)),
                      const SizedBox(height: 50),
      ...
      /*body: Scrollbar(child: SingleChildScrollView(
        ...
        child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(children: [
          ...
          *//*Text(AppConstants.APP_NAME, style: IBMPlexSansArabicBold.copyWith(
  ...
  Widget element(BuildContext context,{required String image, required String title, required String subTitle, required Function() onTap}){
    return InkWell(
      ...
      child: Column( mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text(title, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
        const SizedBox(height: Dimensions.paddingSizeExtraLarge),
