    ...
    return Center(child: SizedBox(width: width ?? Dimensions.webMaxWidth, child: Padding(
      ...
      child: TextButton(
        ...
        child: isLoading ? Center(child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('loading'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Colors.white)),
        ]),
          ...
          Text(buttonText, textAlign: TextAlign.center,  style: isBold ? IBMPlexSansArabicBold.copyWith(
              color: textColor ?? (transparent ? Theme.of(context).primaryColor : Colors.white),
              fontSize: fontSize ?? Dimensions.fontSizeDefault,
            ) : IBMPlexSansArabicRegular.copyWith(
              color: textColor ?? (transparent ? Theme.of(context).primaryColor : Colors.white),
              fontSize: fontSize ?? Dimensions.fontSizeDefault,
            )
          ),
