              ...
              return InkWell(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    ...
                    Text(authController.isLoggedIn() ? 'profile'.tr : 'sign_in'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, fontWeight: FontWeight.w100)),
                  ]),
                ),
              );
            }),
                  ...
                  child: TextHover(builder: (hovered) {
                    return  Row(
                      children: [
                        ...
                        Text(AppConstants.joinDropdown[index].tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, fontWeight: FontWeight.w100, color: Get.find<ThemeController>().darkTheme ? Colors.white : Colors.black)),
                        index == 0 ? const SizedBox(width: Dimensions.paddingSizeSmall) : const SizedBox(),
  ...
  Widget build(BuildContext context) {
    return TextHover(builder: (hovered) {
      return InkWell(
        ...
        child: Text(title, style: IBMPlexSansArabicRegular.copyWith(color: hovered ? Theme.of(context).primaryColor : null)),
      );
    });
  }
}
            ...
            (isCart && cartController.cartList.isNotEmpty) ? Positioned(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: IBMPlexSansArabicRegular.copyWith(fontSize: 12, color: Theme.of(context).cardColor),
                ),
              ),
            ) : const SizedBox()
          ]);
