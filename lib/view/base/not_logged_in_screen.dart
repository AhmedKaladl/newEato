    ...
    return Center(
      child: Padding(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text(
            'sorry'.tr,
            style: IBMPlexSansArabicBold.copyWith(fontSize: MediaQuery.of(context).size.height*0.023, color: Theme.of(context).primaryColor),
          ...
          Text(
            ...
            style: IBMPlexSansArabicRegular.copyWith(fontSize: MediaQuery.of(context).size.height*0.0175, color: Theme.of(context).disabledColor),
            textAlign: TextAlign.center,
          ),
          ...
          SizedBox(
            ...
            child: CustomButton(buttonText: 'login_to_continue'.tr, /*height: 40,*/ onPressed: () async {
              ...
              if(!ResponsiveHelper.isDesktop(context)) {
                ...
                Get.dialog(const Center(child: AuthDialog(exitFromApp: false, backFromThis: false))).then((value) => callBack(true));
