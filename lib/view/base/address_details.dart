  ...
  Widget build(BuildContext context) {
    return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text(
        ...
        style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall), maxLines: 4, overflow: TextOverflow.ellipsis,
      ),
      ...
      Wrap(children: [
        (addressDetails!.road != null && addressDetails!.road!.isNotEmpty) ? Text('${'street_number'.tr}: ${addressDetails!.road!}${(addressDetails!.house != null && addressDetails!.house!.isNotEmpty) ?',' : ' '}',
          style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall), maxLines: 2, overflow: TextOverflow.ellipsis,
        ) : const SizedBox(),
