          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            title != null ? Padding(
              ...
              child: Text(
                ...
                style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: titleColor),
              ),
            ) : const SizedBox(),

            Padding(
              padding: EdgeInsets.all(isDelete == true ? Dimensions.paddingSizeSmall : Dimensions.paddingSizeLarge),
              child: Text(description, style: isDelete == true? IBMPlexSansArabicRegular : IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge), textAlign: TextAlign.center),
            ),
                  ...
                  return (orderController.isLoading || userController.isLoading) ? const Center(child: CircularProgressIndicator()) : Row(children: [
                    Expanded(child: TextButton(
                      ...
                      child: Text(
                        ...
                        style: IBMPlexSansArabicBold.copyWith(color: isDelete == true ? Theme.of(context).cardColor : Theme.of(context).textTheme.bodyLarge!.color),
                      ),
                    )),
