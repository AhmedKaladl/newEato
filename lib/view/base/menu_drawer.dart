    ...
    _menuList.add(Menu(icon: Images.logOut, title: Get.find<AuthController>().isLoggedIn() ? 'logout'.tr : 'sign_in'.tr, onTap: () {
      ...
      if(Get.find<AuthController>().isLoggedIn()) {
        ...
        if(ResponsiveHelper.isDesktop(context)){
          Get.dialog(const AuthDialog(exitFromApp: false, backFromThis: false));
        }else{
        ...
        children: [
          Container(
            ...
            child: Row( mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Text('menu'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: 20 )),
                    ...
                    child: InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Row(children: [
                          ...
                          Expanded(child: Text(_menuList[index].title, style: IBMPlexSansArabicMedium, overflow: TextOverflow.ellipsis, maxLines: 1)),
