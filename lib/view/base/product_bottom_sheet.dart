                        ...
                        Padding(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                              ...
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  Text(
                                    widget.product!.name!, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                                  ...
                                  Row(children: [
                                    price > priceWithDiscount ? Text(
                                      PriceConverter.convertPrice(price), textDirection: TextDirection.rtl,
                                      style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).disabledColor, decoration: TextDecoration.lineThrough),
                                    ) : const SizedBox(),
                              ...
                              Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                ...
                                (Get.find<SplashController>().configModel!.toggleVegNonVeg!) ? Container(
                                  ...
                                  child: Row(children: [
                                    ...
                                    Text(widget.product!.veg == 1 ? 'veg'.tr : 'non_veg'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                                  ]),
                                ) : const SizedBox(),
                            ...
                            (widget.product!.description != null && widget.product!.description!.isNotEmpty) ? Column(
                              ...
                              children: [
                                Text('description'.tr, style: IBMPlexSansArabicMedium),
                                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                Text(widget.product!.description!, style: IBMPlexSansArabicRegular),
                                const SizedBox(height: Dimensions.paddingSizeLarge),
                              ],
                            ) : const SizedBox(),
                                ...
                                return Container(
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
                                      Text(widget.product!.variations![index].name!, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                                    ...
                                    Row(children: [
                                      widget.product!.variations![index].multiSelect! ? Text(
                                        ...
                                        style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
                                      ) : Text(
                                        'select_one'.tr,
                                              ...
                                              child: Row(children: [
                                                Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                                                  ...
                                                  Text(
                                                    ...
                                                    style: productController.selectedVariations[index][i]! ? IBMPlexSansArabicMedium : IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).hintColor),
                                                  ),
                                                ...
                                                price > priceWithDiscount ? Text(
                                                  ...
                                                  style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor, decoration: TextDecoration.lineThrough),
                                                ) : const SizedBox(),
                                                ...
                                                Text(
                                                  ...
                                                  maxLines: 1, overflow: TextOverflow.ellipsis, textDirection: TextDirection.rtl,
                                                  style: productController.selectedVariations[index][i]! ? IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall)
                                                      : IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
                                                )
                                              ]),
                                            ),
                                          );
                            ...
                            widget.product!.addOns!.isNotEmpty ? Column(
                              ...
                              children: [
                                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                  Text('addons'.tr, style: IBMPlexSansArabicMedium),
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      'optional'.tr,
                                      style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall),
                                    ),
                                  ),
                                ]),
                                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                      ...
                                      child: Row(children: [
                                        ...
                                        Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                                          ...
                                          Text(
                                            ...
                                            maxLines: 1, overflow: TextOverflow.ellipsis,
                                            style: productController.addOnActiveList[index] ? IBMPlexSansArabicMedium : IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).hintColor),
                                          ),
                                        ...
                                        Text(
                                          ...
                                          maxLines: 1, overflow: TextOverflow.ellipsis, textDirection: TextDirection.rtl,
                                          style: productController.addOnActiveList[index] ? IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall)
                                              : IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                                        ),
                  ...
                  Container(
                    ...
                    child: SafeArea(
                      child: Column(
                        children: [
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text('${'total_amount'.tr}:', style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor)),
                            const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                            ...
                            Row(children: [
                              (priceWithAddonsVariationWithoutDiscount > priceWithAddonsVariation)
                                ...
                                textStyle: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall, decoration: TextDecoration.lineThrough),
                              ) : const SizedBox(),
                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                              PriceConverter.convertAnimationPrice(
                                priceWithAddonsVariation,
                                textStyle: IBMPlexSansArabicBold.copyWith(color: Theme.of(context).primaryColor),
                              ),
                          ...
                          Row(
                            children: [
                              Row(children: [
                                ...
                                // Text(productController.quantity.toString(), style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                                QuantityButton(
  ...
  void _showCartSnackBar() {
    ScaffoldMessenger.of(Get.context!).showSnackBar(SnackBar(
      ...
      content: Text(
        ...
        style: IBMPlexSansArabicMedium.copyWith(color: Colors.white),
      ),
    ));
  }
