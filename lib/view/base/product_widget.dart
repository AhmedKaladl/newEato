            ...
            Expanded(child: Padding(
              ...
              child: Row(children: [
                ...
                ((image != null && image.isNotEmpty) || isRestaurant) ? Stack(children: [
                  ClipRRect(
                    ...
                    child: CustomImage(
                      ...
                      height: desktop ? 120 : length == null ? 120 : 85, width: desktop ? 120 : 90, fit: BoxFit.cover,
                    ),
                  ),
                  DiscountTag(
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    isRestaurant ? Row(children: [
                      ...
                      Text(isRestaurant ? restaurant!.avgRating!.toStringAsFixed(1) : product!.avgRating!.toStringAsFixed(1), style: IBMPlexSansArabicMedium),
                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                      Text('(${isRestaurant ? restaurant!.ratingCount : product!.ratingCount})', style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                    ]) : const SizedBox(),
                    ...
                    //!isRestaurant ? Row(children: [
                     ...
                     // Text(product!.avgRating!.toStringAsFixed(2), style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall,),
                     // ),
                     // const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                     // Text('(${product!.ratingCount})', style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                    ///]) : const SizedBox(),
                    ...
                    isRestaurant ? Row(children: [
                        ...
                        Text(
                          ...
                          style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, fontWeight: FontWeight.w700, color: Theme.of(context).textTheme.bodyLarge!.color),
                        ),
                      ...
                      discount! > 0 ? Text(
                        PriceConverter.convertPrice(product!.price), textDirection: TextDirection.rtl,
                        style: IBMPlexSansArabicMedium.copyWith(
                          fontSize: Dimensions.fontSizeExtraSmall,
                      ...
                      Text(
                        ...
                        style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor), textDirection: TextDirection.rtl,
                      ),
                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                ...
                Column(mainAxisAlignment: isRestaurant ? MainAxisAlignment.center : MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, children: [
                  ...
                  fromCartSuggestion ? const SizedBox() : GetBuilder<WishListController>(builder: (wishController) {
