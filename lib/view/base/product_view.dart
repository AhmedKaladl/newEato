...
import 'package:efood_multivendor/view/base/web_restaurant_widget.dart';
...
class ProductView extends StatelessWidget {
  ...
  const ProductView({Key? key, required this.restaurants, required this.products, required this.isRestaurant, this.isScrollable = false,
    ...
    this.isCampaign = false, this.inRestaurantPage = false, this.showTheme1Restaurant = false, this.isWebRestaurant = false}) : super(key: key);
    ...
    return Column(children: [
      ...
      !isNull ? length > 0 ? GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          childAspectRatio: ResponsiveHelper.isDesktop(context) && !isWebRestaurant! ? 50 : isWebRestaurant! ? 1.5 : showTheme1Restaurant ? 1.9 : 2.5,
