          ...
          SizedBox(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,crossAxisAlignment: CrossAxisAlignment.start, children: [
              Expanded(flex: 4, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('subscribe_to_out_new_channel_to_get_latest_updates'.tr, style: IBMPlexSansArabicRegular.copyWith(color: _color, fontSize: Dimensions.fontSizeSmall)),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: TextField(
                      ...
                      expands: false,
                      style: IBMPlexSansArabicMedium.copyWith(color: Colors.black, fontSize: Dimensions.fontSizeExtraSmall),
                      decoration: InputDecoration(
                        hintText: 'your_email_address'.tr,
                        hintStyle: IBMPlexSansArabicRegular.copyWith(color: Colors.grey, fontSize: Dimensions.fontSizeExtraSmall),
                    ...
                    GetBuilder<SplashController>(builder: (splashController) {
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          child: !splashController.isLoading ? Text('subscribe'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeExtraSmall))
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text('about'.tr, style: IBMPlexSansArabicBold.copyWith(color: _color, fontSize: Dimensions.fontSizeSmall)),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text('quick_links'.tr, style: IBMPlexSansArabicBold.copyWith(color: _color, fontSize: Dimensions.fontSizeSmall)),
                            const SizedBox(height: Dimensions.paddingSizeLarge),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text('for_users'.tr, style: IBMPlexSansArabicBold.copyWith(color: _color, fontSize: Dimensions.fontSizeSmall)),
                            const SizedBox(height: Dimensions.paddingSizeLarge),
                              ...
                              return InkWell(
                                ...
                                onTap: () {
                                  if (Get.find<AuthController>().isLoggedIn()) {
                                    ...
                                    Get.dialog(const Center(child: AuthDialog(exitFromApp: false, backFromThis: true)));
                                  }
                                },
                                child: Text(Get.find<AuthController>().isLoggedIn() ? 'profile'.tr : 'login'.tr, style: hovered ? IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall)
                                    : IBMPlexSansArabicRegular.copyWith(color:  Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeExtraSmall)),
                              );
                            }),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                        ...
                        (_config!.appUrlAndroid != null || _config!.appUrlIos != null) ? Column(
                          ...
                          children: [
                            ...
                            Text('get_app'.tr, style: IBMPlexSansArabicBold.copyWith(color: _color, fontSize: Dimensions.fontSizeSmall)),
                            const SizedBox(height: Dimensions.paddingSizeLarge),
              ...
              child: SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      '© ${_config!.footerText ?? ''}',
                      style: IBMPlexSansArabicRegular.copyWith(color: _color, fontSize: Dimensions.fontSizeExtraSmall, fontWeight: FontWeight.w100),
                    ),
                        ...
                        languageList.add(DropdownMenuItem(
                          ...
                          child: TextHover(builder: (hovered) {
                            return Row(children: [
                              ...
                              Text(AppConstants.languages[index].languageName!, style: IBMPlexSansArabicRegular.copyWith(color: hovered ? Colors.black : Colors.white)),
                            ]);
                          }),
                        ));
  ...
  Widget build(BuildContext context) {
    return TextHover(builder: (hovered) {
      return InkWell(
        ...
        child: Text(title, style: hovered ? IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall)
            : IBMPlexSansArabicRegular.copyWith(color:  Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeExtraSmall)),
      );
    });
  }
