  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        widget.showTitle ? Text(widget.titleText, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)) : const SizedBox(),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).hintColor),
            filled: true,
              ...
              Container(
                  ...
                  child: Center(
                    child: CodePickerWidget(
                      ...
                      textStyle: IBMPlexSansArabicRegular.copyWith(
...
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         widget.showTitle ? Text(widget.hintText, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)) : const SizedBox(),
...
//           focusNode: widget.focusNode,
//           textAlign: widget.textAlign,
//           style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeLarge),
...
//             hintStyle: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor),
//             filled: true,
