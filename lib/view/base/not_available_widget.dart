...
class NotAvailableWidget extends StatelessWidget {
  ...
  const NotAvailableWidget({Key? key, this.fontSize = 8, this.isRestaurant = false}) : super(key: key);
    ...
    return Positioned(
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: IBMPlexSansArabicRegular.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeDefault),
        ),
      ),
    );
  }
