        ...
        child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: Text(
              ...
              style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall,color: Colors.white70),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
            ...
            TextButton(
              ...
              'no_thanks'.tr,
              style: IBMPlexSansArabicRegular.copyWith(color: Colors.white70,fontSize: Dimensions.fontSizeSmall),
            )),
            ...
            TextButton(
              ...
              child:  Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault,vertical: 5),
                child: Center(
                  child: Text(
                  'yes_accept'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Colors.white70,fontSize: Dimensions.fontSizeSmall),
                  ),
                ),
              )),
