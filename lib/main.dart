...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb) {
    await Firebase.initializeApp(options: const FirebaseOptions(
      apiKey: 'AIzaSyCqcwtpykoj5UsuuWnExrLEcNccc3IIYg0',
      appId: '1:524859791727:web:2cf991062862f78391b09a',
      messagingSenderId: '524859791727',
      projectId: 'clear-scene-354922',
    ));
    MetaSEO().config();
  }else {
